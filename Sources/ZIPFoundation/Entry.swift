...
public struct Entry: Equatable {
    ...
    public struct DataDescriptor<T: BinaryInteger>: DataSerializable {
        ...
        public let dataDescriptorSignature = UInt32(dataDescriptorStructSignature)
        public let crc32: UInt32
        ...
        public let compressedSize: T
        public let uncompressedSize: T
        public static var memoryLengthOfSize: Int { MemoryLayout<T>.size }
        public static var size: Int { memoryLengthOfSize * 2 + 8 }
    }
